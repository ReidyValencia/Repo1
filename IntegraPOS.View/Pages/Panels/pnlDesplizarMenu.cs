...
{
    public partial class pnlDesplizarMenu : MetroUserControl
    {
        Form _owner = null;
        bool _loaded = false;
        ...
        private pnlDesplizarMenu()
        {
            InitializeComponent();
        }

        public pnlDesplizarMenu(Form owner) : this()
        {
            this.Visible = false;
            ...
            this.Click += pnlDesplizarMenu_Click;

            ResizeForm();
        }

        void pnlDesplizarMenu_Click(object sender, EventArgs e)
        {
            //swipe(false);
        }
        ...
        public void swipe(bool show = true)
        {
            ...
            _transasition.add(this, "Left", show ? 300 : this.Width);
            _transasition.run();
